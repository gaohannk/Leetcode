...
public class PredicttheWinner {
    ...
    public int winner(int[] nums, int s, int e, int turn) {
        ...
        /**
         * Further, note that the value returned at every step is given by turn *\text{max}(turn * a, turn * b)turn∗max(turn∗a,turn∗b). This is equivalent to the statement max(a,b) for Player 1's turn and min(a,b) for Player 2's turn.
         */
